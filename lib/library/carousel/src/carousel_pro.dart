...
class Carousel extends StatefulWidget {
  ...
  Carousel({
    ...
    this.onImageChange,
    this.defaultImage,
  })  : assert(banners != null || (banners == null && defaultImage != null));
      ...
      if (widget.autoplay) {
        timer = new Timer.periodic(widget.autoplayDuration, (_) {
          if (_controller!.hasClients) {
            if (_controller!.page!.round() == widget.banners!.length - 1) {
  ...
  Widget build(BuildContext context) {
    ...
    (widget.banners != null && widget.banners!.isNotEmpty)
        ...
        .map<Widget>(
          ...
          InkWell(
            onTap: (){
              Navigator.of(context).pushNamed("/ItemDetails", arguments: RouteArgument(product: _banner.product));
            },
            child: new Container(
        decoration: new BoxDecoration(
            ...
            image: new DecorationImage(
              ...
              image: NetworkImage(_banner.image),
              fit: widget.boxFit,
            ),
        ),
