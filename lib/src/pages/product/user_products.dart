...
class UserProductsWidget extends StatefulWidget {
  ...
  UserProductsWidget({this.argument});

  @override
  _UserProductsWidgetState createState() => _UserProductsWidgetState();
}

class _UserProductsWidgetState extends StateMVC<UserProductsWidget> {
  MyProductController? _con;

  _UserProductsWidgetState() : super(MyProductController()) {
                    ...
                    : Padding(
                        ...
                        child: GridView.count(
                          ...
                          children:
                            ...
                            Product product = _con!.products[index];
