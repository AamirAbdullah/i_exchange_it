          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                //               onPressed: () {
                //                 setState(() {
                //                   _con!.onlyWithVideos = !_con!.onlyWithVideos;
                //                 });
                //                 _con!.filterWithBiddingPicturesAndVideos();
                //               },
                //               icon: Icon(
                ...
                ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) => container(
                        context: context,
                        category: _con!.categories[index].name,
                        ontap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                                    DetailSearch(argument: widget.argument,id:_con!.categories[index].id,
                                    searchtext:_con!.searchTextController!.text,),
