...
class OtherItemsGrid extends StatelessWidget {

 final HomeController? con;
 final List<Product>? products;

  OtherItemsGrid({this.con, this.products});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GridView.count(
        childAspectRatio: isPortrait ? (itemWidth / 251) : (landscapeItemWidth / 251),
        ...
        children: List.generate(
            this.products!.length,
              ...
              return HomeGridWidgetItem(
                product: product,
                onTap: (){
                  Navigator.of(context).pushNamed("/ItemDetails", arguments: RouteArgument(product: product));
                },
                onFav: (){
