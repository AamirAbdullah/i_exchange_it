...
class CategorySearchFilterBottomSheetWidget extends StatefulWidget {
 final CategoriesController? con;

  CategorySearchFilterBottomSheetWidget({this.con});

  @override
  _CategorySearchFilterBottomSheetWidgetState createState() =>
      _CategorySearchFilterBottomSheetWidgetState();
}

class _CategorySearchFilterBottomSheetWidgetState
    extends StateMVC<CategorySearchFilterBottomSheetWidget> {
